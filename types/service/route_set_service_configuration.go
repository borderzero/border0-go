...
// RouteSetServiceConfiguration represents service
// configuration for route_set services (fka sockets).
type RouteSetServiceConfiguration struct {
...
// Validate validates the RouteSetServiceConfiguration.
func (c *RouteSetServiceConfiguration) Validate() error {
